...
| [Claude 2](https://www.anthropic.com/index/claude-2) | Cloud 2 artificial intelligence from Anthropic company (requires a virtual number) | claude-2 | ✅
...
| [Midjourney](https://www.midjourney.com/) | Production of wonderful images by Midgerni artificial intelligence Midjourney v5 | ✅+💲 |
...
| [runway]()||| ✅
| [lluma]()||| ✅
| [Lumalabs](https://lumalabs.ai/dashboard/imagine) | Production of 3D models Luma Labs AI | ✅
| [Plask](https://dashboard.plask.ai/login) | Production of animation by artificial intelligence Flask AI | ✅
| [Civitai](https://civitai.com/) | A variety of tasks such as image production, text production and video composition Stable Diffusion ✅
| [Gravitai](https://webui.graviti.com/?c=A870D787&utm_source=civitai&__theme=dark) | A hosting platform that allows users to discover art produced by artificial intelligence Stable Diffusion ✅
| [Sea Art AI](https://www.seaart.ai/home) | Photo production models by artificial intelligence ReV Animated, beautiful Realistic Asians, ChilloutMix, majicMIX realistic, ... | ✅
| [Happy Accidents](https://www.happyaccidents.ai/create) | Production of artistic images and design using artificial intelligence models | ✅
| [Tensorplay AI](https://tensorplay.ai/models/28303/run) | Explore, create, share and monetize over 16,000 AI models | ✅+💲 |
| []()||| ✅
...
| [Consensus](https://consensus.app/search/) | Find answers in research articles | ✅
| [krater.ai](https://www.krater.ai/app)| An artificial intelligence toolkit for content creation including image generation, chat automation, speech-to-text and text-to-speech capabilities || ✅+💲 |
| [AI Scholar](https://ai-chat.scholarcn.com/) | Artificial intelligence, essay writing and student research assistant GPT-3, Wu Dao 2, Jurassic-1 Jumbo, Megatron-Turing NLG | ✅+💲 |
| [INK](https://inkforall.com/) | Helping you create eBooks, flipbooks, reports, white papers, and sales presentations |💲 |
| [Writesonic](https://writesonic.com/) | It offers various products and features for creating and editing content | 💲
| [Article Forge](https://www.articleforge.com/)| is an online article generator that uses artificial intelligence to create content based on keywords entered by users || ✅+💲 |
| [Jasper AI](https://www.jasper.ai/)| Creating content using artificial intelligence || 💲
| [WordAi](https://wordai.com/)| Rewrites content using advanced machine learning models. It claims to produce high-quality, human-like text that can pass AI detectors || 💲
| [Hypotenuse AI](https://www.hypotenuse.ai/)| It's an AI-powered text generator that can help you create content for websites, blogs, e-stores, and more. It can also generate images from text and overwrite your existing content || 💲
| [Copysmith](https://copysmith.ai/)| is a platform that uses artificial intelligence to help write high-performance copy for various types of marketing-related content. || 💲
